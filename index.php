...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>How to send email with attachment in PHP  &ndash; Coding Selim Reza Swadhin</title>
    ...
    <meta name="twitter:description" content="Demo &ndash; Selim Reza Swadhin is a blogging website, minimizes the difficulties of coding and development that every new fresher faces in his career. we provide information on free resources, techniques of coding and problem-solving codes on our website." />
    <meta name="twitter:title" content="Demo &ndash; Selim Reza Swadhin" />
    <meta name="twitter:creator" content="@DeveloperSelim Reza Swadhin" />
    ...
    <meta property="og:url" content="https://demo.selimrezaswadhin.com/" />
    <meta property="og:site_name" content="Demo &ndash; Selim Reza Swadhin" />
    ...
    <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li><a href="https://demo.selimrezaswaddhin.com/">Demos</a></li>
                    <li><a href="https://selimrezaswaddhin.com/about-ankit/">About</a></li>
                    <li><a href="https://blog.selimrezaswaddhin.com/">Blog</a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-12 footer-text text-center">
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Designed & Developed <i class="fa fa-heart-o" style="color: #6788F8" aria-hidden="true"></i> by <a href="https://selimsezaswadhin.com" target="_blank">Selim Reza Swadhin</a>
            </p>
        </div>
    </div>
</footer>
